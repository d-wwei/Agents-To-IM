#!/usr/bin/env bash
# install.sh — One-line installer for agent-to-im
...
INSTALL_DIR="${HOME}/.claude/skills/agent-to-im"
MIN_NODE_MAJOR=20
...
printf "\n"
printf "  ${BOLD}/agent-to-im setup${RESET}\n"
printf "\n"
...
printf "\n"
printf "  ${BOLD}/agent-to-im start${RESET}\n"
printf "\n"
printf "For help or troubleshooting:\n"
printf "  ${BOLD}/agent-to-im doctor${RESET}\n"
