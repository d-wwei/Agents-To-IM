<#
.SYNOPSIS
  Windows daemon manager for Agent-to-IM bridge.
...
<service>
  <id>$ServiceName</id>
  <name>Agent-to-IM Bridge</name>
  <description>Agent-to-IM bridge daemon</description>
...
function Install-NSSMService {
    ...
    & $NSSMPath set $ServiceName Description "Agent-to-IM bridge daemon"
