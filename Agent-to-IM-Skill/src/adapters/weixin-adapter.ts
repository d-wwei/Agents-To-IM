import type {
  ...
  OutboundMessage,
  SendResult,
} from 'agent-to-im-core/src/lib/bridge/types.js';
import { BaseChannelAdapter, registerAdapterFactory } from 'agent-to-im-core/src/lib/bridge/channel-adapter.js';
import { getBridgeContext } from 'agent-to-im-core/src/lib/bridge/context.js';
import {
  getWeixinAccount,
