/**
 * Daemon entry point for agent-to-im-skill.
 *
...
import { initBridgeContext } from 'agent-to-im-core/src/lib/bridge/context.js';
import * as bridgeManager from 'agent-to-im-core/src/lib/bridge/bridge-manager.js';
// Side-effect import to trigger adapter self-registration
import 'agent-to-im-core/src/lib/bridge/adapters/index.js';
import './adapters/weixin-adapter.js';

import type { LLMProvider } from 'agent-to-im-core/src/lib/bridge/host.js';
