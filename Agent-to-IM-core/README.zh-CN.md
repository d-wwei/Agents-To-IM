...
Agent-to-IM-core 是一个与宿主应用解耦的桥接库，用于将 [Claude Code SDK](https://docs.anthropic.com/en/docs/claude-code/sdk) 连接到 IM 平台，让用户可以通过 Telegram、Discord 和飞书直接与 Claude 交互。
...
Agent-to-IM-core 从 CodePilot 中提取出来作为独立库，供需要在自己的应用中嵌入 IM 桥接能力的开发者使用。
