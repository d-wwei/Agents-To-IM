...
function trimmedString(value: string | boolean | undefined): string {
  return typeof value === 'string' ? value.trim() : '';
}

export const DISCORD_SLASH_COMMANDS: DiscordSlashCommandDefinition[] = [
  {
    name: 'start',
...
export function buildDiscordSlashCommandText(
  commandName: string,
