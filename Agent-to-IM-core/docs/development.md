...
This document covers everything you need to integrate Agent-to-IM-core into your own application: host interface specifications, SSE stream format, step-by-step integration walkthrough, adapter development, and troubleshooting.
...
Agent-to-IM-core uses dependency injection via a global context. Your application must:
...
Your Application
    ...
    |
    v
Agent-to-IM-core (handles IM ↔ LLM message flow automatically)
```
